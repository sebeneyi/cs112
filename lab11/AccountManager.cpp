 ...
 *        || an Exception is thrown if the precondition is not met.
 */
...
void AccountManager::changeUserName(const string& oldUserName, const string& newUserName) {
	...
	if (it != myAccounts.end()) {
		...
		throw Exception("AccountManager::changeUserName", "not in the system");
	}
...
void AccountManager::deleteAccount(const string& userName) {
	...
	if (it != myAccounts.end()) {
		...
		throw Exception("AccountManager::deleteAccount()", "not in the system");
	}
...
void AccountManager::changePassword(const string& userName,
	...
	if (it != myAccounts.end()) {
		...
		throw Exception("AccountManager::changePassword", "not in the system");
	}
